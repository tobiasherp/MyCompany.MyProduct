...
# $VIRTUAL_ENV/Products/unitracc/tools/debug2.py:
# from MyCompany.MyProduct.tools.debug2 import log_or_trace, pp

DirectoryView.registerDirectory('skins', globals())

lot_kwargs = {'debug_level': 1,
              'trace': 1,
	      }

from MyCompany.MyProduct import config
